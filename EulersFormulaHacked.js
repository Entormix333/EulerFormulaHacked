...
var id = "?";
var name = "Euler's Formula Hacked";
    ...
    content: ui.createStackLayout({
        children: [
            ui.createFrame({
                heightRequest: 309,
                cornerRadius: 0,
                content: ui.createLabel({text: "Top of The Class",
            ...
            ui.createButton({text: "Hacked Value Currency 1", onClicked: () => currency.value = 1e308()})
            ui.createButton({text: "Hacked Value Currency 2", onClicked: () => currency_R.value = 1e308()})
            ui.createButton({text: "Hacked Value Currency 3", onClicked: () => currency_I.value = 1e308()})
            ui.createButton({text: "Hacked Value dt", onClicked: () => dt = 1e308()})
